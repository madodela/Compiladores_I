...
namespace Analizador_Lexico
{
	class AnalizadorLexico {
		...
		public enum States {
			...
			IN_COMMA, IN_EQU, IN_NEQU, IN_ADD, IN_MINUS, IN_EOF, IN_ERROR,
			IN_DONE, IN_LESS, IN_GR, IN_SOME_KIND_OF_COMMENT, IN_COMMENT, IN_MLCOMMENT
		};
...
//								state=States.IN_SOME_KIND_OF_COMMENT;
								state = States.IN_DONE;
								token.Lexema += c.ToString();
							} else if (c == '<') {
...
//						case States.IN_SOME_KIND_OF_COMMENT: {
//							c = GetChar(readerFile);
//							if(c == '/') {
...
//							c = GetChar(readerFile);
//							char c2 = GetChar(readerFile);
//							while(c != '*' && c2 != '/') {
//								c = GetChar(readerFile);
//								c2 = GetChar(readerFile);
//							}
//							//unGetChar();
//							state = States.IN_DONE;
//							break;
